...
# set nodes (used in 'get_datapackage_metadata()' in script 10a) 
...
# create hashes to store (1) attribute ids (keys) in (to determine uniqueness) and (2) updated metadata 'doc's
...
##############################
# filter here for subset of data to update (e.g. update subset of 'standalone' pkgs)
##############################
