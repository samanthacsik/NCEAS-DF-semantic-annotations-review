annotate_single_otherEntity_multiple_attributes <- function(doc, eml_att_num, current_attribute_id, attributeName_subset){
  
  # add attribute id to metadata
  doc$dataset$otherEntity$attributeList$attribute[[eml_att_num]]$id <- current_attribute_id
  ...
  doc$dataset$otherEntity$attributeList$attribute[[eml_att_num]]$annotation$propertyURI <- list(label = "contains meausurements of",
  ...
  doc$dataset$otherEntity$attributeList$attribute[[eml_att_num]]$annotation$valueURI <- list(label = current_label,
