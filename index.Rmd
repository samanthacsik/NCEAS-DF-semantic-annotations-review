...
datatable(Table3_annotation_counts, 
          ...
          filter = 'top', options = list(pageLength = 5, autoWidth = TRUE))
```
<span style="color: darkred;">**NOTE:**</span> You can download **Table 3** as a .csv file [here](https://drive.google.com/file/d/1bTitU9xKJKM8S8tJoDZ3Qs-32QJlQ5CJ/view?usp=sharing).
