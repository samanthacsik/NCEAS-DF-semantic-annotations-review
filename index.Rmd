...
## **Outline:**
  ...
  3. Summary of most commonly used semantic annotations
      ...
      * Figure 2: most commonly used attribute-level annotations used in data packages uploaded pre vs. post-August 2020
      * Table 3^+^: counts of attribute-level annotations used across the ADC corpus (total, pre-Aug. 2020, post-Aug. 2020)
...
# datatable(streamlined,
#           class = 'cell-border stripe',
#           colnames = c("package identifier", "attributeName", "semantic annotation (preferred name)", "semantic annotation (value URI)"),
#           caption = htmltools::tags$caption(
#             style = 'caption-side: top; text-align: left;', 'Table 5: ', 
#             htmltools::em('Data package identifiers and their associated attributes')),
#           filter = 'top', options = list(pageLength = 5, autoWidth = TRUE))
```

* Raw data (extracted attribute information) from the 2020-10-12 solr query can be downloaded [here](https://drive.google.com/file/d/1X59s65_pZOt2e_Z8g4ch-tUyrcJzim28/view?usp=sharing).
